"""
Image-to-Table-Cell Mapper

Maps images to table cells based on Y-axis positioning.
Logic: Find the table cell where the image's Y coordinates fall within the cell's range.
"""
...
class ImageTableCellMapper:
    """
    Mapper that associates images with table cells based on Y-axis positioning
    """
    
    def __init__(self, pdf_path: str, output_manager=None):
        self.pdf_path = pdf_path
        self.output_manager = output_manager
        logger.info(f"ImageTableCellMapper initialized for {pdf_path}")
